...
void main() {
  ...
  test('getTimes returns sun phases for the given date and location', () {
    ...
    expect(times.solarNoon!.toIso8601String().substring(0, 19) + "Z",
        testTimes['solarNoon']);
    expect(times.nadir!.toIso8601String().substring(0, 19) + "Z",
        testTimes['nadir']);
    expect(times.sunrise!.toIso8601String().substring(0, 19) + "Z",
        testTimes['sunrise']);
    expect(times.sunset!.toIso8601String().substring(0, 19) + "Z",
        testTimes['sunset']);
    expect(times.sunriseEnd!.toIso8601String().substring(0, 19) + "Z",
        testTimes['sunriseEnd']);
    expect(times.sunsetStart!.toIso8601String().substring(0, 19) + "Z",
        testTimes['sunsetStart']);
    expect(times.dawn!.toIso8601String().substring(0, 19) + "Z",
        testTimes['dawn']);
    expect(times.dusk!.toIso8601String().substring(0, 19) + "Z",
        testTimes['dusk']);
    expect(times.nauticalDawn!.toIso8601String().substring(0, 19) + "Z",
        testTimes['nauticalDawn']);
    expect(times.nauticalDusk!.toIso8601String().substring(0, 19) + "Z",
        testTimes['nauticalDusk']);
    expect(times.nightEnd!.toIso8601String().substring(0, 19) + "Z",
        testTimes['nightEnd']);
    expect(times.night!.toIso8601String().substring(0, 19) + "Z",
        testTimes['night']);
    expect(times.goldenHourEnd!.toIso8601String().substring(0, 19) + "Z",
        testTimes['goldenHourEnd']);
    expect(times.goldenHour!.toIso8601String().substring(0, 19) + "Z",
        testTimes['goldenHour']);
  });
